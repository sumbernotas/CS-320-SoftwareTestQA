...
public class TaskServiceTest {
	...
	@Test
	public void updateTaskNameNullTEST() {
		TaskService task = new TaskService();
		String tempID = task.newTask("Task Name", "Task description");
		task.updateTaskName(tempID, " ");
		assertNotNull(task.findTask(tempID).getTaskName(), "Task name was null");
		
	}
	
	@Test
	public void updateTaskDescriptionNullTEST() {
		TaskService task = new TaskService();
		String tempID = task.newTask("Task Name", "Task description");
		task.updateTaskDescription(tempID, " ");
		assertNotNull(task.findTask(tempID).getTaskName(), "Task name was null");
